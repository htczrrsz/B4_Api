...
public class JsonToJava {
    ...
    public void putAllUsersToList(){
        ...
        String actualEJobOfExperience= (String) experience.get(2).get("job");
        String expectedJobOfExperience="Junior Developer";
        Assert.assertEquals(actualEJobOfExperience,expectedJobOfExperience);
    ...
    public void bookStoreUserTest_NegativeCase(){
        ...
        //verify all data inside the json body into a java collection
        //de-serilization
        //json to Java
